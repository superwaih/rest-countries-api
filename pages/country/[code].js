  ...
  return (
    <div>
      <div className="back-btn  p-6">
        <button
          className="shadow flex items-center dark:bg-DarkModeElement rounded text-[13px] p-3"
          onClick={handleBack}
        >
          <BiArrowBack />
          Back
      ...
      {country.map((data, i) => {
        return (
          <div
            key={i}
            className="country-detail flex flex-col lg:flex-row  space-y-5 p-6"
          >
              ...
              <div className="statsBox flex flex-col md:flex-row ">
                <div className="native space-y-2 text-[14px]">
                  ...
                  <p className="font-semibold">
                    Population:{" "}
                    <span className="dark:text-gray-300 font-light">
                      {data.population
                        .toString()
                        .replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                    </span>
                ...
                <div className="otherstats md:pl-5 text-[14px]">
                  ...
                  <p className="font-semibold">
                    ...
                    {data.languages.map((lang, i) => {
                      return (
                        <span
                          className="dark:text-gray-300 font-extralight"
                          key={i}
                        >
                          {" "}
                          {lang.name}{" "}
